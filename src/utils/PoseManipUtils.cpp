...
bool PoseManipUtils::string_to_eigenmat( const string mat_string, Matrix4d& mat )
{
...
bool PoseManipUtils::string_to_eigenmat( const string mat_string, Matrix<double,6,6>& mat )
{
    auto mat_string_split = split( mat_string, ';' );
